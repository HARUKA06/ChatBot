...
# Owner / Admin
OWNER_ID = int(os.getenv("8306720320", 8306720320))
OWNER_USERNAME = os.getenv("OWNER_USERNAME")

# Support / Updates
SUPPORT_GRP = os.getenv("SUPPORT_GRP", "https://t.me/JAWANON_KA_ADDA")
UPDATE_CHNL = os.getenv("UPDATE_CHNL", "https://t.me/JAWANON_KI_TOLI")
